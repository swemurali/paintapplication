...
<html lang="en">
  <head>
    ...
    <style>
        ...
        #myCanvas{
          ...
          box-shadow: inset 0 0 5px #ab0cf5; 
          border-radius: 7px; 
          border: 7px solid #f14c8f ;
        }
        #buttonstyle{
          background-color: #f14c8f;
          border: 4px solid #f9db7b;
          border-radius: 7px;
          color: #f9db7b;
          padding: 15px 32px;
          text-align: center;
        ...
        #buttonstyle:hover{
            background-color:rgb(248, 14, 104);
            transition: 0.5s;
        }
        #bgimg{
          background-color:rgb(14, 213, 248);
            transition: 500ms;
        }
        #shooky{
            border: 2px solid rgb(100, 5, 100);
            border-radius: 25px;
            padding: 25px 25px;
            text-align: center;
            display: inline-block;
  ...
  <body id="bgimg">
    <div id="content">
      ...
      <button onclick="change_color(this)" id="shooky" style="background: rgba(226, 2, 2, 0.993);"></button>
      <button onclick="change_color(this)" id="shooky" style="background: rgb(241, 119, 20);"></button>
      <button onclick="change_color(this)" id="shooky" style="background: rgba(97, 54, 4, 0.808);"></button>
    ...
    <center><p id="demo" style="color: rgb(70, 3, 3);"></p></center>
    <p 
    style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; 
    text-align: center;
    color:rgb(102, 7, 7);
    font-weight: bold;
    font-size: larger;">Paint Application Program, Developed by Suwetha.M &#128151</p>
  </body>
</html>
```
